 ...
 * @run main/othervm TestLonelyClassChanged
 */
public class TestLonelyClassChanged implements PairProjectProvider {

    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestLonelyClassChanged());
    }
