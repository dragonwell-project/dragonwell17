 ...
 * @run main/othervm TestInnerClassChanged
 */
public class TestInnerClassChanged implements PairProjectProvider {

    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestInnerClassChanged());
    }
