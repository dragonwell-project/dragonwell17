 ...
 * @run main/othervm TestRemoveJarInPlainJar
 */
public class TestRemoveJarInPlainJar implements PairProjectProvider {
    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestRemoveJarInPlainJar());
    }
