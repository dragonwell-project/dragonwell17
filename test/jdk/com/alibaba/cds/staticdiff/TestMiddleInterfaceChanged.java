 ...
 * @run main/othervm TestMiddleInterfaceChanged
 */
public class TestMiddleInterfaceChanged implements PairProjectProvider {

    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestMiddleInterfaceChanged());
    }
    ...
    private Project currProject = ProjectUtil.updateSource(baseProject, "interface",
            JavaSourceUtil.updateMethod(interfaceSource, "com.intf.IDecorate", "getDecorateStr",
                    ...
                    , null),
            new ExpectOutput(new String[]{"<<<<<<<<<<!foo^@", "<<<<<<<<<<###foo^$$$", "barqqq",
                    "com/intf/IDecorate found in invalid classes list",
                    "com/impl1/Style1" + StaticDiffTestConstant.INVALID_CLASS_KEYWORD_IN_LOG,
                    "com/impl1/Style2" + StaticDiffTestConstant.INVALID_CLASS_KEYWORD_IN_LOG},
                    new String[]{
                            "com/impl2/Style3" + StaticDiffTestConstant.INVALID_CLASS_KEYWORD_IN_LOG,
                            ...
                            "com/intf/ISuffix" + StaticDiffTestConstant.INVALID_CLASS_KEYWORD_IN_LOG
                    }));
}
