 ...
 * @run main/othervm TestClassNotFoundClasses
 */
public class TestClassNotFoundClasses implements PairProjectProvider {
    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestClassNotFoundClasses());
    }
