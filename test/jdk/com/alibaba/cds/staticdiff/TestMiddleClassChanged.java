 ...
 * @run main/othervm TestMiddleClassChanged
 */
public class TestMiddleClassChanged implements PairProjectProvider {

    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestMiddleClassChanged());
    }
    ...
    private Project currProject = ProjectUtil.updateSource(baseProject, "sub", JavaSourceUtil.updateMethod(subClassSource, "com.a.SonB", "eat",
            ...
            new ExpectOutput(new String[]{"Call A.<init>",
                    "com/a/SonB" + StaticDiffTestConstant.INVALID_CLASS_KEYWORD_IN_LOG,
                    "com/a/GrandSonB" + StaticDiffTestConstant.INVALID_CLASS_KEYWORD_IN_LOG,
            }, new String[]{
