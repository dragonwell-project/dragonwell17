 ...
 * @run main/othervm TestClassNotFoundFatJar
 */
public class TestClassNotFoundFatJar implements PairProjectProvider {
    public static void main(String[] args) throws Exception {
        new StaticDiffTestRunner().runTest(new TestClassNotFoundFatJar());
    }
    ...
    private Project baseProject = new Project(new RunFatJarConf(StaticDiffTestConstant.DISCOUNT_MAIN.getClassName()),
            new Artifact[]{
    ...
    private Project currProject = new Project(new RunFatJarConf(StaticDiffTestConstant.DISCOUNT_MAIN.getClassName()),
            new Artifact[]{
                    Artifact.createFatJar("fat-jar", "fat-lib", "all-discount.jar", new Artifact[]{
                            Artifact.createPlainJar("discount", "lib", "discount.jar", null,
