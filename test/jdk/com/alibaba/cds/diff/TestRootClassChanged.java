 ...
 * @run main/othervm TestRootClassChanged static
 * @run main/othervm TestRootClassChanged dynamic
 */
public class TestRootClassChanged extends PairProjectProvider {

    public TestRootClassChanged(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestRootClassChanged(args[0]));
    }
    ...
    private Project currProject = ProjectUtil.updateSource(baseProject, "base", JavaSourceUtil.updateClass(baseClassSource, "com.a.A", "package com.a;\npublic class A {" +
            ...
            new ExpectOutput(new String[]{"Enter A.<init>",
                    ...
                    isStaticDiff ? "com/a/SonA" + Constant.INVALID_CLASS_KEYWORD_IN_LOG :
                                    Constant.DYNAMIC_SUPER_VERIFICATION_FAILED + "com/a/SonA",
                    isStaticDiff ? "com/a/GrandSonA" + Constant.INVALID_CLASS_KEYWORD_IN_LOG :
                                    Constant.DYNAMIC_SUPER_VERIFICATION_FAILED + "com/a/GrandSonA",
            }));
}
