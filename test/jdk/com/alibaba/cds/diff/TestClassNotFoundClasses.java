 ...
 * @run main/othervm TestClassNotFoundClasses static
 * @run main/othervm TestClassNotFoundClasses dynamic
 */
public class TestClassNotFoundClasses extends PairProjectProvider {

    public TestClassNotFoundClasses(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestClassNotFoundClasses(args[0]));
    }
