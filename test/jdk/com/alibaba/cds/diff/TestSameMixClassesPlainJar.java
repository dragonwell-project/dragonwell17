 ...
 * @run main/othervm TestSameMixClassesPlainJar static
 * @run main/othervm TestSameMixClassesPlainJar dynamic
 */
public class TestSameMixClassesPlainJar extends PairProjectProvider {

    public TestSameMixClassesPlainJar(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestSameMixClassesPlainJar(args[0]));
    }
