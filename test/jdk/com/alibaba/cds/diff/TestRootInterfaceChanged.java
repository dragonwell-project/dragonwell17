 ...
 * @run main/othervm TestRootInterfaceChanged static
 * @run main/othervm TestRootInterfaceChanged dynamic
 */
public class TestRootInterfaceChanged extends PairProjectProvider {

    public TestRootInterfaceChanged(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestRootInterfaceChanged(args[0]));
    }
    ...
    private Project currProject = ProjectUtil.updateSource(baseProject, "interface",
            ...
            new ExpectOutput(new String[]{"?###foo?$$$", "barqqq",
                    ...
                    isStaticDiff ? "com/intf/IDecorate" + Constant.INVALID_CLASS_KEYWORD_IN_LOG :
                                    Constant.DYNAMIC_INTERFACE_VERIFICATION_FAILED + "com/intf/IDecorate",
