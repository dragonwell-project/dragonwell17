 ...
 * @run main/othervm TestDiffClasses static
 * @run main/othervm TestDiffClasses dynamic
 */
public class TestDiffClasses extends PairProjectProvider {

    public TestDiffClasses(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestDiffClasses(args[0]));
    }
