 ...
 * @run main/othervm TestLeafClassChanged static
 * @run main/othervm TestLeafClassChanged dynamic
 */
public class TestLeafClassChanged extends PairProjectProvider {

    public TestLeafClassChanged(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestLeafClassChanged(args[0]));
    }
    ...
    private Project currProject = ProjectUtil.updateSource(baseProject, "impl2",
            ...
            new ExpectOutput(new String[]{"^!foo^@", "barooo",
                    ...
                    new String[]{"com/impl1/Style1" + Constant.INVALID_CLASS_KEYWORD_IN_LOG}));
}
