 ...
 * @run main/othervm TestSameFatJars static
 * @run main/othervm TestSameFatJars dynamic
 */
public class TestSameFatJars extends PairProjectProvider {

    public TestSameFatJars(String arg) {
        super(arg);
    }

    public static void main(String[] args) throws Exception {
        new DiffTestRunner().runTest(new TestSameFatJars(args[0]));
    }
